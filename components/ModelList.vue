<template>
  <div id="list">
    <div id="menu">
      <Menu active-name="jm" @on-select="onSelect">
        <MenuItem name="jm">JM模型</MenuItem>
        <MenuItem name="go">GO模型</MenuItem>
        <MenuItem name="mo">MO模型</MenuItem>
        <MenuItem name="bp">BP模型</MenuItem>
        <MenuItem name="svm">SVM模型</MenuItem>
      </Menu>
    </div>
    <div id="info">
      <div v-if="name === 'jm'">
